  ...
  return (
    <Form {...form}>
      ...
      <div className = "sm:w-420 flex-center flex-col">
        ...
        <p className = "text-light-3 small-medium md:base-regular mt-2">Please enter account details</p>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 flex flex-col gap-5 w-full mt-4 mb-4">
          ...
          <p className = "text-small-regular text-light-2 text-center mt-2">
            ...
            <Link to = "/sign-up" className = "text-cyan text-small-semibold ml-1"> Sign up</Link>
          </p>
        </form>
      </div>
    </Form>
